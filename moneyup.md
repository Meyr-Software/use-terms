...
1.5. A Money Up Brasil não se responsabilizará por problemas envolvendo atendimento, pagamento, danos, extravios, entre outros, no momento da utilização do cupom digital de desconto no estabelecimento parceiro, uma vez que não gerência ou participa das atividades desenvolvidas pelo estabelecimento.
...
2.5. Para realização do cadastro serão solicitadas as seguintes informações: nome completo, idade, e-mail, telefone, CPF, cidade e estado de residência. A conta criada ficará vinculada ao CPF e e-mail fornecidos pelo usuário no momento do cadastro. Portanto, o usuário não poderá criar mais de uma conta no aplicativo.
...
3.2. O pagamento do plano escolhido será realizado em moeda corrente nacional, através de um link de pagamento que se encontra dentro do aplicativo e também no site www.moneyupbrasil.com.br. A confirmação do pagamento é de responsabilidade exclusiva da administradora do link, a empresa PagSeguro e pode levar até 48 horas.
...
4.3. O usuário que cancelar a assinatura antes do seu vencimento poderá reativá-la a qualquer momento antes do vencimento.
4.4. A exclusão e ou desinstalação do Aplicativo do smartphone do usuário não significa o cancelamento da assinatura. Para tanto deverá entrar em contato pelos canais de atendimento.

``
UTILIZAÇÃO DO APLICATIVO
``

5.1. Confirmado o pagamento, o usuário receberá um código (chave) através do e-mail cadastrado no momento da ativação, sendo podendo o usuário começar a usufruir dos serviços.
...
5.6. Para o correto funcionamento do Aplicativo, o usuário deverá autorizar que este tenha acesso à câmera do smartphone para realizar a leitura do QR Code. Este procedimento só precisa ser executado uma única vez. Para tanto deverá seguir este caminho no aplicativo: menu “minha área”, “configurações gerais, “permissões” e realizar os procedimentos indicados. Finalizado o procedimento, o usuário estará apto a ler o QR Code no seu aplicativo.
